...
#'                      or 
#'                      list(site = config$site_id, site_size = nrow(ipdata), 
...
#' @param ipdata local data in data frame (generated in \code{pda}, is a list(ipdata, X_count, X_zero) if family='hurdle')
...
ODAP.synthesize <- function(ipdata, control, config) {
  ...
  # if (control == control) { # for all models other than hurdle
